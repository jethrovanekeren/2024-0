...
THIS IS THE FINAL VERSION AS THE CLASS ENDED.

THIS VERSION IS FROZEN FOR HISTORICAL PURPOSES.

ANOTHER (EVOLVING) BRANCH EXISTS.
...
%Consider $\g = sl_2$. In a typical block of $\OO$ there are exactly $5$ indecomposable modules.
...
% Here are two examples: $sl_2$ and $sl_3$.
% \begin{center}
